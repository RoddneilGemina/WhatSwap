...
urlpatterns = [
    ...
    path('trades/trade_update/<int:pk>/', views.trade_update, name="trade_update"),
    path('directed_select_item/<int:pk>/', views.directed_select_item, name="directed_select_item"),
